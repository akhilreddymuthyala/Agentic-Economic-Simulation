      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div
          style={{
            ...
            color: savedMsg === 'Error' ? '#ff3366' : '#00ff88'
          }}
        >
          {savedMsg}
        </div>
      ...
      >
        ...
        <Panel title="Economic Policy Controls">
          ...
          <SliderRow
            ...
            value={policy.government_spending}
            min={0}
            max={200000}
            step={1000}
            unit="$"
          ...
          <SliderRow
            ...
            value={policy.market_regulation}
            min={0}
            max={100}
            unit="%"
            color="#a855f7"
        ...
        <Panel title="Resource Supply Controls">
          ...
          <SliderRow
            ...
            value={resource.energy_availability}
            min={0}
            max={100}
            unit="%"
            color="#00d4ff"
          ...
          <SliderRow
            ...
            value={resource.water_resources}
            min={0}
            max={100}
            unit="%"
            color="#ff3366"
        ...
        <Panel title="Social Controls">
          ...
          <SliderRow
            ...
            value={social.social_influence_strength}
            min={0}
            max={2}
            step={0.05}
            color="#a855f7"
